...
public class ComplaintPage10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complaint_page10);
        ...
        finalsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ComplaintPage10.this, "Your complaint has been registered.", Toast.LENGTH_LONG).show();
