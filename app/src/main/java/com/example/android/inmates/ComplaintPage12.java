...
public class ComplaintPage12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complaint_page12);
        ...
        finalsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String  message= "Complaint-Form"+"\n"+"Complaint-Type-Server-Room"+"\n"+"Name-" + name2+ "\n" + "Roll-Number-" + rollno2 + "\n"+"Room-Number-"+ roomno +"\n"+ "Hostel-Number-" + hostelno +"\n"+"Description-" + description+"\n"+"Availability-" +availability;
                final String toArr = "vivek.alladi26@gmail.com";

                Toast.makeText(ComplaintPage12.this, "Your complaint has been registered.", Toast.LENGTH_LONG).show();
