...
public class ComplaintPage3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complaint_page3);
        ...
        finalsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String  message= "Complaint-Form"+"\n"+"Complaint-Type-Cleaner"+"\n"+"Name-" + name2+ "\n" + "Roll-Number-" + rollno2 + "\n"+"Room-Number-"+ roomno +"\n"+ "Hostel-Number-" + hostelno +"\n"+"Description-" + description+"\n"+"Availability-" +availability;
                final String toArr = "vivek.alladi26@gmail.com";

                Toast.makeText(ComplaintPage3.this, "Your complaint has been registered.", Toast.LENGTH_LONG).show();
